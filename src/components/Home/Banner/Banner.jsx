    ...
    return (
        <div className='container px-4 mx-auto'>
            <div class="grid grid-cols-1 md:grid-cols-2 items-center my-24">
                <div className=''>
                    <h3 style={{color: "#1a1a1a"}} className='roboto-medium leading-relaxed md:leading-relaxed text-3xl md:text-4xl my-10 '>
                ...
                <div className='mx-auto'>
                    <img className='sm:w-72 md:w-96' src="https://i.ibb.co.com/PWDqC66/dp.png" alt="" />
                </div>
            </div>
        </div>
