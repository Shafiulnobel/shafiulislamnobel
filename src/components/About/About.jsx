...
const About = () => {
    return (
        <div>
            <h2 className='playfair-medium text-3xl text-center' >About Me</h2>
            <div className='container px-4 mx-auto'>
                <div className='grid grid-cols-1 md:grid-cols-2 gap-4 items-center py-16'>
                    ...
                    <div>
                        <p className='text-2xl roboto-regular leading-relaxed'>I am a designer addicted to the craft. I ❤️ designing interactions that make technology feel effortless. Building engaging experiences is what drives me. I started my journey in computer engineering, but found solace in art. </p>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-4 items-center py-16'>
                    ...
                    <div className='order-2 md:order-1'>
                        <h1 className='text-3xl roboto-medium mb-4'>Additional Skills</h1>
                        <p className='text-xl mb-6 roboto-regular'>
                        ...
                        <ul className='list-disc roboto-regular'>
